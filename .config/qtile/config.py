        ...
        top=bar.Bar(
            [
                widget.TextBox(
                       ...
                       padding = 0,
                       fontsize = 20,
                     mouse_callbacks = {'Button1': lambda qtile: qtile.cmd_spawn('rofi -show drun -show-icons -fullscreen True -lines 5 -line-margin 5 -padding 300 -bw 0')},
                       ),
                widget.TextBox(
                       text = '',
                       background = "#37474F",
                ...
                widget.Backlight(
                       ...
                       brightness_file = "/sys/class/backlight/radeon_bl0/actual_brightness",
...
#                       ),
                ...
                widget.Net(
                       ...
                       format = ' ↓{down} ↑{up}',
                       padding = 5,
                       mouse_callbacks = {'Button1': lambda qtile: qtile.cmd_spawn(myTerm + ' -e nmtui')},
                       ),
